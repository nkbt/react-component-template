...
exports.scripts = {
  ...
  test: {
    ...
    cov: 'cross-env NODE_ENV=test BABEL_DISABLE_CACHE=1' +
    '     babel-istanbul cover --no-default-excludes -x **/node_modules/**' +
  ...
  ci: {
    ...
    cov: 'NODE_ENV=test BABEL_DISABLE_CACHE=1 babel-istanbul cover' +
